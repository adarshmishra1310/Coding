...
//     // for (int i = 0; i < n; i++)
//     // {
//     //     ans.push_back(rnd(1, 100));
//     //     ans2.push_back(rnd(1, 100));
//     //     // cout<<(char)('0'+rnd(0,1));
//     //     // cout<<rnd(1,1000000)<<' ';
//     //     // int a=rnd(1,n);
//     //     // int b=rnd(1,10);
...
int main(){
    ...
    uniform_int_distribution<int> distN(2, 6);
    uniform_int_distribution<int> distC(1, 100);
    int T = 1;
    cout << T << "\n";
    while(T--){
        int N = distN(rng);
        uniform_int_distribution<int> distK(1, N-1);
        int K = distK(rng);
        cout << N << " " << K << "\n";
        for(int i=0;i<N;i++){
            cout << distC(rng) << (i+1<N?' ':'\n');
        }
        string A;
        for(int i=0;i<K;i++){
            A += char('0' + (rng()&1));
